========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : CardGame
========================================================================


AppWizard が生成した CardGame には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには CardGame を構成している各ファイルの概要説明が含まれています。
...
CardGame.h
    ...
    みます） をインクルードし、また CCardGameApp アプリケーションクラスを宣
    言します。

CardGame.cpp
    このファイルは CCardGameApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\CardGame.ico
    ...
    ルです。このアイコンはリソース ファイル CardGame.rc によってインクルード
    されます。
...
res\Toolbar.bmp
    ...
    リソースエディタで編集し、CardGame.rc ファイル内の IDR_MAINFRAME TOOLBAR 配列を
    変更してください。
/////////////////////////////////////////////////////////////////////////////

AppWizard は 1 つのドキュメントタイプと 1 つのビューを作成します。

CardGameDoc.h, CardGameDoc.cpp - ドキュメント
    これらのファイルは CCardGameDoc クラスを含みます。特別なドキュメント デ
    ータを付け加えたり、CCardGameDoc::Serialize を使ったファイルのセーブや
    ロード機能をインプリメントしたいときはこのファイルを編集してください。

CardGameView.h, CardGameView.cpp - ビュー
    これらのファイルは CCardGameView クラスを含みます。
    CCardGameView オブジェクトは CCardGameDoc オブジェクトを表示するために
    使います。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) CardGame.pch 
